...
import {getAllPokemon, getAllPokemonByType, getPokemon} from "../Service/pokemonService";
    ...
    return (
        <div>
            {loading ? (
                ...
                <>
                    <CardHeader avatar={"Filter"} action={<>
                        <IconButton onClick={handleClickFilter}><FilterList/></IconButton>
                    </>}/>
                    ...
                    <Dialog
                        ...
                        keepMounted
                    >
                        <DialogTitle id="alert-dialog-title"><FilterList/>&nbsp;{"Filter List"}</DialogTitle>
                        <DialogContent className={classes.dialog_content}>
                            {types.map((type, index) => (
                                <Chip key={index} onClick={() => changeFilterItem(type)} label={type} variant="outlined"
                                      className={
                                          clsx(
                                              classes.chip_list_item,
                                              renderSelected(type)
                                          )}
